  ...
  return (
    <section className="py-20 bg-gradient-to-br from-red-50 via-white to-red-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Team Grid -> Chuyển thành Flex để canh giữa */}
        <motion.div
          variants={containerVariants}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          // SỬA Ở ĐÂY: Thay grid bằng flex, justify-center để canh giữa
        ...
        >
          {teamMembers.map((member) => (
            <motion.div
              ...
              // SỬA Ở ĐÂY: Thêm width cố định (w-full max-w-[320px]) để thẻ đều nhau
            ...
            >
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-2xl hover:border-red-200 transition-all duration-300 h-full flex flex-col">
                ...
                <div className="pt-14 pb-6 px-6 text-center flex-grow flex flex-col">
                  ...
                  {/* Skills - Dùng margin-top auto để đẩy phần dưới xuống đáy nếu content ngắn */}
